...
interface PersonalProps {
    themeConfig: {
        ...
        userGender: boolean,
        userGoogleAccount: boolean,
        userFacebook: boolean,
        userTwitter: boolean,
...
export default function UserViewDealer({ themeConfig, handleThemeConfig }: PersonalProps) {
    ...
    return (
        <Box>
            <Box mt='20px'>
                <Typography variant='button' component='p' sx={{ fontWeight: 900 }}>What do you need of customer data?</Typography>
                <Typography variant='caption' color='#8688A3'>Select the most important information that you need from your customer profile.</Typography>
            </Box>

            <Box mt='20px'>
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Full Name</Typography>
                    <Switch
                        size='medium'
                ...
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Mobile Number</Typography>
                    <Switch
                        size='medium'
                ...
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Birth Date</Typography>
                    <Switch
                        size='medium'
                ...
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Gender</Typography>
                    <Switch
                        size='medium'
            ...
            <Typography variant='button' component='p' sx={{ fontWeight: 900 }}>Allow Social Media Login</Typography>

            <Box >
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Google Account</Typography>
                    <Switch
                        size='medium'
                ...
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Facebook</Typography>
                    <Switch
                        size='medium'
                ...
                <Stack mb='10px' direction='row' alignItems='center' justifyContent='space-between'>
                    <Typography variant='caption' fontWeight={900}>Twitter</Typography>
                    <Switch
                        size='medium'
