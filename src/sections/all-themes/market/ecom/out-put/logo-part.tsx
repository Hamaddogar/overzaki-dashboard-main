...
//   const handleChangeEvent = (key: any, newValue: any, parentClass: any) => {
...
//   });
//   useEffect(() => {
//     setAppBarLogo((prev) => ({ ...prev, logo: themeConfig?.logo }));
//   }, [themeConfig?.logo]);
...
//         </Typography>
//         <Switch
//           checked={appBarLogo?.status}
//           onChange={() => {
//             setIsLogo((pv) => ({ ...pv, status: !pv.status }));
//             setAppBarLogo((prev) => ({ ...prev, status: !prev.status }));
//           }}
...
//                 setAppBarLogo((prev) => ({ ...prev, position: event?.target?.value }));
//               }}
//             >
...
//                       setAppBarLogo((prev) => ({ ...prev, width: `${event.target.value}px` }));
//                     }}
//                   />
//                 </Stack>
//               </Stack>
...
//                       setAppBarLogo((prev) => ({ ...prev, height: `${event.target.value}px` }));
//                     }}
//                   />
//                 </Stack>
//               </Stack>
...
//                     setAppBarLogo((prev) => ({ ...prev, text: event.target.value }));
//                   }}
//                 />
//               </Stack>
//               <Box sx={{ width: '100%', my: 2 }}>
...
//         <Stack direction="row" alignItems="center" spacing="18px">
//           {/* <MuiColorInput sx={{ width: "100%", margin: "auto", }} variant="outlined"
// >>>>>>> 3e381bf7ae067c0d05d1baad7ec36fc479dc59fb
...
//                         : null,
//                         setAppBarLogo((prev) => ({ ...prev, textBg: event?.hex }));
//                     }}
...
//                         : null,
//                         setAppBarLogo((prev) => ({ ...prev, textColor: event?.hex }));
//                     }}
//                     presetColors={customPresets}
//                     style={{ width: '100%' }}
//                   />
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" width={'100%'}>
        ...
        <Switch
          ...
          onChange={(event: any, value: any) => {
            handleChangeEvent('status', value)
            setIsLogo((pv) => ({ ...pv, status: !pv.status }))
          }}
          inputProps={{ 'aria-label': 'controlled' }}
        />
